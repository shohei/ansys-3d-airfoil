...
#define THREAD_STORE_START(t)(STRUCT_REF(t,1008,void *))
#define THREAD_STORAGE_START(t)(STRUCT_REF(t,1000,void *))
...
#define P_VF(p)STRUCT_REF(p,2400,real)
#define P_CF(p)STRUCT_REF(p,2408,real)
#define P_VFF(p)STRUCT_REF(p,2416,real)
#define P_DF(p)STRUCT_REF(p,2424,real)
...
#define P_EVAP_SPECIES_INDEX(p)STRUCT_REF(P_INJECTION(p),6896,int)
#define P_DEVOL_SPECIES_INDEX(p)STRUCT_REF(P_INJECTION(p),6900,int)
#define P_OXID_SPECIES_INDEX(p)STRUCT_REF(P_INJECTION(p),6904,int)
#define P_PROD_SPECIES_INDEX(p)STRUCT_REF(P_INJECTION(p),6908,int)
